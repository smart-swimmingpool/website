...
[design.background]
  ...
  # Background image.
  image = "smart-swimming-pool-mobile-app.jpg"  # Name of image in `static/img/`.
...
**Automatisiere deinen Swimming Pool auf smarte Weise.**

Ein Opensource-Projekt zur smarten Verwaltung deines Swimming Pools über die Heimautomatisierung.
